class TendersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tender.save
        format.html { redirect_to root_url, notice: 'Tender was successfully created.' }
  ...
  private
    ...
    def tender_params
      params.require(:tender).permit(:user_id, :category_id, :title, :install_date, :tendering_end_date, :description, :electrican, :no_of_electricans, :roofer, :no_of_roofers)
    end
end

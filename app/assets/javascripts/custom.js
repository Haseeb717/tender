						...
						for(var k = 0; k < ths.length; k++){
							if(trs[j].getElementsByTagName('td').length > 0){
								if(navigator.userAgent.toLowerCase().indexOf('firefox') > -1){
									trs[j].getElementsByTagName('td')[k].style.width = ths[k].offsetWidth-24;
								}else{
									trs[j].getElementsByTagName('td')[k].style.width = ths[k].offsetWidth;
								}
							}
							/*else{
								ths[k].style.width = ths[k].offsetWidth;
							}*/
						}
					}
				}
